...
namespace ShiftOS.WinForms
{
    ...
    /// Button control.
    /// </summary>
    public class ButtonFuckBorder : Gwen.Control.Label
    {
        ...
        public ButtonFuckBorder(Base parent)
            : base(parent)
        {
        ...
        protected void Render(Gwen.Skin.Base skin)
        {
            base.Render(skin);
        ...
        public virtual void SetImage(string textureName, bool center = false)
        {
            ...
            TextPadding = new Gwen.Padding(m_Image.Right + 2, TextPadding.Top, TextPadding.Right, TextPadding.Bottom);
        }
        ...
        /// </summary>
        /// <param name="skin">Skin to use.</param>
        protected void Layout(Gwen.Skin.Base skin)
        {
            base.Layout(skin);
            if (m_Image != null)
            {
