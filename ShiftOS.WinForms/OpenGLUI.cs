...
namespace ShiftOS.WinForms
{
    public class ShiftOSSkin : Gwen.Skin.Base
    {
        ...
        public override void DrawMenu(Gwen.Control.Base control, bool paddingDisabled)
        {
            int w = control.Width;
            int h = control.Height;
        ...
        public override void DrawShadow(Gwen.Control.Base control)
        {
            int w = control.Width;
            int h = control.Height;
        ...
        public override void DrawRadioButton(Gwen.Control.Base control, bool selected, bool depressed)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawCheckBox(Gwen.Control.Base control, bool selected, bool depressed)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawGroupBox(Gwen.Control.Base control, int textStart, int textHeight, int textWidth)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawTextBox(Gwen.Control.Base control)
        {
            ...
            {
                padding = 2;
                m_Renderer.DrawColor = (control as TextBox).TextColor;
                m_Renderer.DrawFilledRect(rect);
            }
        ...
        public override void DrawTabControl(Gwen.Control.Base control)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawWindow(Gwen.Control.Base control, int topHeight, bool inFocus)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawWindowCloseButton(Gwen.Control.Base control, bool depressed, bool hovered, bool disabled)
        {
            // TODO
            DrawButton(control, depressed, hovered, disabled);
        }

        public override void DrawHighlight(Gwen.Control.Base control)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawScrollBar(Gwen.Control.Base control, bool horizontal, bool depressed)
        {
            Rectangle rect = control.RenderBounds;
            if (depressed)
        ...
        public override void DrawScrollBarBar(Gwen.Control.Base control, bool depressed, bool hovered, bool horizontal)
        {
            //TODO: something specialized
            DrawButton(control, depressed, hovered, false);
        }

        public override void DrawTabTitleBar(Gwen.Control.Base control)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawProgressBar(Gwen.Control.Base control, bool horizontal, float progress)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawListBox(Gwen.Control.Base control)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawListBoxLine(Gwen.Control.Base control, bool selected, bool even)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawSlider(Gwen.Control.Base control, bool horizontal, int numNotches, int barSize)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawComboBox(Gwen.Control.Base control, bool down, bool open)
        {
            DrawTextBox(control);
        }

        public override void DrawKeyboardHighlight(Gwen.Control.Base control, Rectangle r, int iOffset)
        {
            Rectangle rect = r;
        ...
        public override void DrawToolTip(Gwen.Control.Base control)
        {
        ...
        public override void DrawScrollButton(Gwen.Control.Base control, Pos direction, bool depressed, bool hovered, bool disabled)
        {
        ...
        public override void DrawComboBoxArrow(Gwen.Control.Base control, bool hovered, bool depressed, bool open, bool disabled)
        {
        ...
        public override void DrawNumericUpDownButton(Gwen.Control.Base control, bool depressed, bool up)
        {
            //DrawButton( control.Width, control.Height, depressed, false, true );
        ...
        public override void DrawTreeButton(Gwen.Control.Base control, bool open)
        {
            Rectangle rect = control.RenderBounds;
            rect.X += 2;
            rect.Y += 2;
        ...
        public override void DrawTreeControl(Gwen.Control.Base control)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawTreeNode(Gwen.Control.Base ctrl, bool open, bool selected, int labelHeight, int labelWidth, int halfWay, int lastBranch, bool isRoot)
        {
            if (selected)
            {
        ...
        public override void DrawStatusBar(Gwen.Control.Base control)
        {
            // todo
        }

        public override void DrawColorDisplay(Gwen.Control.Base control, Color color)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawModalControl(Gwen.Control.Base control)
        {
        ...
        public override void DrawMenuDivider(Gwen.Control.Base control)
        {
            Rectangle rect = control.RenderBounds;
        ...
        public override void DrawMenuRightArrow(Gwen.Control.Base control)
        {
            DrawArrowRight(control.RenderBounds);
        }

        public override void DrawSliderButton(Gwen.Control.Base control, bool depressed, bool horizontal)
        {
            DrawButton(control, depressed, control.IsHovered, control.IsDisabled);
        }

        public override void DrawCategoryHolder(Gwen.Control.Base control)
        {
            // todo
        }

        public override void DrawCategoryInner(Gwen.Control.Base control, bool collapsed)
        {
            // todo
        }
        #endregion
