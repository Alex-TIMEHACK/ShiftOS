...
namespace Gwen.Control
{
    ...
    public class Base : IDisposable
    {
        ...
        private Texture m_background_image = null;
        ...
        /// <summary>
        /// Gets or sets whether the control and its parents are visible.
        /// </summary>
        ...
        {
            if(BackgroundImage?.RendererData != null)
            {
                var r = skin.Renderer;
                r.Begin();
                r.DrawColor = Color.White;
